...
<head>
	...
	<title>UYAK2023 İstanbul - <?=$PageTitle?></title>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<strong class="tg-logo"><a href="/"><img src="view/site/assets/images/uyak-logo-2.png"
							...
							<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
								<ul>
									<li class="current-menu-item">
										<a href="http://uyak.org.tr">Anasayfa</a>
									</li>
					...
					<a class="langswitchmobile tg-btn tg-btnbookseat" href="?lang=en">EN</a>
				</div>
			</div>
		</div>
	</header>
