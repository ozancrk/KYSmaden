				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<ul class="tg-address tg-addressfooter">
						<li><span><i class="fa fa-solid fa-location-pin"></i></span>
							<span><address>TMMOB Maden Mühendisleri Odası İstanbul Şubesi <br> Büyükdere Cad. Çınar Apt. No:95 Kat:8 <br>Daire:31
                                Mecidiyeköy - İstanbul
                            </address></span>
						</li>
						<li><span><i class="fa fa-solid fa-phone"></i></span><span><em>+90 212 3567410</em></span></li>
						<li><span><i class="fa fa-brands fa-whatsapp"></i></span><span><em>+90 546 4251079</em></span>
						</li>
						<li><span><i class="fa fa-solid fa-paper-plane"></i></span><span>uyak@uyak.org.tr</span></li>
					...
					<ul class="tg-socialicons">
						...
						<li><a href="https://www.instagram.com/uyak2023/" target="_blank"><i
									class="fa fa-brands fa-instagram"></i></a></li>
						<li><a href="https://twitter.com/uyak2023" target="_blank"><i
									class="fa fa-brands fa-twitter"></i></a></li>
						<li><a href="https://www.facebook.com/UYAK2023/" target="_blank"><i
					...
					<strong class="tg-logo text-center"><a href="/"><img style="margin: auto;" src="view/site/assets/images/uyak-logo-2.png"></a></strong>
					<strong class="tg-logo text-center" > <a href="/yonetim"><img style="margin: 30px 0 0 0; max-width:100%" src="uploads/pms_tr_white.png"></a></strong>
